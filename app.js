...
document.addEventListener("keydown", logKey);
    ...
    function logKey(e) {
            if (div1.innerText == ""){
                div1.innerText = e.key.toUpperCase();
            }
            else if (div2.innerText == ""){
                div2.innerText = e.key.toUpperCase();
            }
            else if (div3.innerText == ""){
                div3.innerText = e.key.toUpperCase();
            }
            else if (div4.innerText == ""){
                div4.innerText = e.key.toUpperCase();
            }
            else if (div5.innerText == ""){
                div5.innerText = e.key.toUpperCase();
            }
            chosenword = div1.innerText + div2.innerText +div3.innerText +div4.innerText +div5.innerText;
        }
...
function submit(){
    ...
    for (let i = 0; i < arrayForChosen.length; i++){
        ...
        //POSSIBILITA' DI LETTERE GIALLE
            ...
            if (((letterTofindinChosen > letterToFindInSelected) && (0 <= control.length) && (control.length <= 1))){
